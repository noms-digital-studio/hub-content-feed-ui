...
class VideosRepository
{
	...
	public function find($nid)
	{
		...
		return new Video(
			$video->nid, $video->title, $video->description, $video->video_url, !empty($video->thumbnail) ? $video->thumbnail : "", !empty($video->duration) ? $video->duration : "", !empty($video->categories) ? $video->categories : "", $video->tags, !empty($video->channel_name) ? $video->channel_name : ""
		);
	}
